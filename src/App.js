...
function App() {
  ...
  return (
    ...
    //   <div>
    //     <p>Complex</p>
    //     <h2>{`Company: ${complex[0].company} & Jobs: ${complex[0].jobs}`}</h2>
    //     <p>From map method</p>
    //     {complex.map((v) => (
    //       <div>
    ...
    // Json place holder data using after storing in post variable note: Not thorugh api.//
    <div className="root">
      <h1>Json-Place-holder data </h1>
